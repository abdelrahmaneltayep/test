...
export const STRINGS: Dict = {
  ...
  adminOrg: { en: 'HIGHBASE Operations', ar: 'عمليات هاي بيس' },
  roleAdmin: { en: 'Platform administrator', ar: 'مدير المنصة' },
  bothParties: { en: 'Buyer · Supplier', ar: 'المشتري · المورّد' },

  // ── HB Admin — Feature Flow Draft §10 ─────────────────────────────────────
  adminNavOverview: { en: 'Overview', ar: 'نظرة عامة' },
  adminNavGroup: { en: 'Price oversight', ar: 'الرقابة على الأسعار' },
  adminNavNegotiated: { en: 'Negotiated orders', ar: 'الطلبات المتفاوض عليها' },
  adminNavAllOrders: { en: 'All orders', ar: 'كل الطلبات' },
  adminOverviewTitle: { en: 'Price oversight', ar: 'الرقابة على الأسعار' },
  adminOverviewSub: { en: 'Every order whose price went through a negotiation, and how each one came out.', ar: 'كل طلب مرّ سعره بمفاوضة، وكيف انتهى كل منها.' },
  adminNegotiatedTitle: { en: 'Negotiated orders', ar: 'الطلبات المتفاوض عليها' },
  adminNegotiatedSub: { en: 'Open a row for the full back-and-forth and the document it was decided on.', ar: 'افتح أي صف لعرض المراسلات كاملة والمستند الذي بُني عليه القرار.' },
  adminAllOrdersTitle: { en: 'All orders', ar: 'كل الطلبات' },
  adminAllOrdersSub: { en: 'Standard and negotiated together, as both trading parties see them.', ar: 'الطلبات العادية والمتفاوض عليها معاً، كما يراها طرفا التعامل.' },
  adminReadOnly: { en: 'This view is read-only. HIGHBASE staff can follow a price after the fact; they cannot change one, and the history log cannot be edited or deleted by any role.', ar: 'هذه الشاشة للاطلاع فقط. يمكن لفريق هاي بيس تتبّع السعر بعد حدوثه، ولا يمكنه تغييره، والسجل غير قابل للتعديل أو الحذف من أي دور.' },
  adminStatNegotiated: { en: 'Negotiated orders', ar: 'طلبات متفاوض عليها' },
  adminStatMoved: { en: 'Where the price moved', ar: 'تغيّر فيها السعر' },
  adminStatMatched: { en: 'Verified prices matched', ar: 'أسعار مُثبتة تمت مطابقتها' },
  adminStatNoProof: { en: 'Without a document', ar: 'بلا مستند' },
  adminReasonsTitle: { en: 'Why suppliers declined', ar: 'أسباب رفض المورّدين' },
  adminReasonsSub: { en: 'Grouped by the reason the supplier gave. A decline has carried one since price matching.', ar: 'مُجمّعة حسب السبب الذي ذكره المورّد. صار الرفض يحمل سبباً منذ اعتماد مطابقة الأسعار.' },
  adminNoDeclines: { en: 'No supplier has declined a request here.', ar: 'لم يرفض أي مورّد طلباً هنا.' },
  adminNoReasonRecorded: { en: 'No reason on the record', ar: 'لا سبب مسجّل' },
  adminOrdersColumn: { en: 'Orders', ar: 'الطلبات' },
  adminReasonGiven: { en: 'Reason given', ar: 'السبب المذكور' },
  adminPriceColumn: { en: 'Order total', ar: 'إجمالي الطلب' },
  adminFilterAll: { en: 'All', ar: 'الكل' },
  adminFilterMoved: { en: 'Price moved only', ar: 'ما تغيّر سعره فقط' },
  adminShowingCount: { en: 'Showing {shown} of {total}', ar: 'عرض {shown} من {total}' },
  adminEmptyTitle: { en: 'Nothing matches these filters', ar: 'لا شيء يطابق هذه الفلاتر' },
  adminEmptyBody: { en: 'Widen the outcome filter, or clear "price moved only".', ar: 'وسّع فلتر النتيجة، أو ألغِ خيار «ما تغيّر سعره فقط».' },
  adminLogImmutable: { en: 'The history log is append-only and cannot be edited or deleted by any role, including HIGHBASE administrators.', ar: 'السجل غير قابل للتعديل أو الحذف من أي دور، بما في ذلك إدارة المنصة.' },
  ...
  tabClosed: { en: 'Closed', ar: 'مغلق' },
  emptyClosedTitle: { en: 'Nothing closed yet', ar: 'لا يوجد مغلق بعد' },
  emptyClosedBody: { en: 'Requests land here once they are accepted, declined, cancelled or expired.', ar: 'تنتقل الطلبات إلى هنا بعد قبولها أو رفضها أو إلغائها أو انتهاء صلاحيتها.' },
  ...
  matchBelowCost: { en: 'Matching puts {sku} below your cost of {cost} — this order loses {amount}.', ar: 'المطابقة تضع {sku} تحت تكلفتك البالغة {cost} — وهذا الطلب يخسر {amount}.' },
  ...
  // ── The verification panel: the seller's screen answers "is the claim good?" ──
  verifyTitle: { en: 'Verify this claim', ar: 'تحقّق من هذا الادعاء' },
  verifyHint: { en: 'The price is not in question — the document is. Match it unless one of these is wrong.', ar: 'السعر ليس محل نقاش — المستند هو المقصود. طابقه ما لم يكن أحد هذه العناصر خاطئاً.' },
  verdictClean: { en: 'The document passed every automatic check.', ar: 'اجتاز المستند كل الفحوص التلقائية.' },
  verdictWarn: { en: 'The automatic checks flagged something. Read them below before you match.', ar: 'رصدت الفحوص التلقائية ملاحظة. اقرأها أدناه قبل المطابقة.' },
  verdictFailed: { en: 'An automatic check failed. Ask for better evidence rather than matching.', ar: 'فشل أحد الفحوص التلقائية. اطلب إثباتاً أفضل بدلاً من المطابقة.' },
  verdictNoDocument: { en: 'No document was attached, so nothing could be checked.', ar: 'لم يُرفق أي مستند، فلم يكن هناك ما يُفحص.' },
  verifyTheClaim: { en: 'The claim', ar: 'الادعاء' },
  verifyYourPosition: { en: 'Where matching leaves you', ar: 'أين تضعك المطابقة' },
  theirPrice: { en: 'Their price', ar: 'سعرهم' },
  yourList: { en: 'Your list price', ar: 'سعرك المعلن' },
  onThisOrder: { en: 'On this order', ar: 'على هذا الطلب' },
  againstList: { en: 'against {amount} at list', ar: 'مقابل {amount} بالسعر المعلن' },
  marginAfterMatch: { en: 'Margin after matching', ar: 'الهامش بعد المطابقة' },
  yourFloor: { en: 'Your floor', ar: 'حدك الأدنى' },
  yourCost: { en: 'Your cost', ar: 'تكلفتك' },
  belowBy: { en: 'below by {amount}', ar: 'أقل بـ {amount}' },
  aboveBy: { en: 'above by {amount}', ar: 'أعلى بـ {amount}' },
  notConfigured: { en: 'Not configured', ar: 'غير محدد' },
  ...
  negotiationMatched: { en: 'Price matched', ar: 'تمت مطابقة السعر' },
  negotiationNegotiated: { en: 'Price negotiated', ar: 'سعر متفاوض عليه' },
  negotiationRejected: { en: 'Price declined', ar: 'تم رفض السعر' },
  negotiationOpen: { en: 'Price under negotiation', ar: 'السعر قيد التفاوض' },
