  ...
  function renderWhy(){
    var V = [
      { k: "A", name: "One thing to do",
        how: "The confirmation drops to a single line. The page becomes the amount, the account to send it to, and one primary button. The QR and what-happens-next sit behind disclosures, and the upload zone is the last thing on the card.",
    ...
    $("#screen-why").innerHTML =
      ...
      '<ul class="doc-list">' +
        ...
        '<li><b>The QR is a choice, not a column.</b> It takes half the live page whether or not the buyer uses it. A and B hold it behind one line; C gives it a tab beside the bank details.</li>' +
      ...
      '<ul class="doc-list">' +
        '<li>The QR frame is a placeholder at the real size — the prototype cannot generate a scannable code and does not fake one.</li>' +
