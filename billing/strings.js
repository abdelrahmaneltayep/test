...
;(function (root, factory) {
  ...
  const S = {
    ...
    invoices: {
      ...
      colTotal: 'Total payable', colStatus: 'Status',
      ...
      simplified: 'A simplified invoice is permitted at or under {max} — this one qualifies.',
      notSimplified: 'Above {max}, so the full tax-invoice fields are mandatory.',
