...
;(function (root, factory) {
  ...
  const S = {
    ...
    rateCard: {
      ...
      conflictNote: 'Subscription Settings shows {label}, effective {date}. That card is not contractual — {applied} is, and it is what your ledger applies. Highbase is correcting the screen.',
      conflictGap: 'On this cycle the advertised card would have charged you {would}. You were charged {charged}, a difference of {gap}. Raise it with Highbase if you signed up on those terms.',
      stale: 'Stale',
    ...
    rateCards: {
      title: 'Rate cards',
      note: 'Versioned, with effective dates. One card is contractual; a card that is advertised but never applied is stale, and stays on the record rather than being deleted — it is what sellers were shown.',
      ...
      contractualBanner: '{label} is the contractual rate. Every posting in the book was priced with it, and it stands.',
      conflictTitle: 'What the other card still costs',
      conflictNote: 'Subscription Settings advertises {advertised} to sellers at signup. That card was never applied and is not contractual — but it was shown, and two sellers have since been charged more than it promised them.',
      correctionNeeded: 'Correct Subscription Settings',
      correctionNote: 'The screen is showing terms that are not the agreement. Until it is changed, every new seller signs up on the strength of a rate they will not get.',
      claimTitle: 'Sellers charged more than they were shown',
      claimNote: 'What the advertised card would have charged, against what the contractual one did. Counterfactual — nothing here has been posted.',
      claimTotal: 'Total exposure if every one of them asked',
      colWould: 'Advertised would charge', colCharged: 'Actually charged', colGap: 'Difference',
      colFirst: 'First order',
      noClaim: 'No seller was charged more than the advertised card promised.',
      overcharged: 'Charged more',
      worked: 'On Gulf Metal Supplies this cycle',
      workedApplied: '{label} charges {amount} across {n} orders.',
      workedAdvertised: '{label} would have charged {amount} on the first order and nothing after it.',
    },
