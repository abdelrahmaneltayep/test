  ...
  function renderWhy(){
    var V = [
      ...
      { k: "B", name: "Confirm", how: "Everything on file is a compact card with one line and <b>Change</b> / <b>Manage</b>. Forms and upload zones exist only behind that button; the page opens on a readiness banner and one primary.", shows: "Is this right? — and one button.", best: "Returning buyers with everything saved: the common case is one look and one click.", risk: "A first-time buyer must open every card; the banner says which." },
